  ...
  <div>
    <div class="rule">
      ...
      <v-card class="rule-card" flat>
        <div class="rule-h">
          この利用規約（以下、「本規約」といいます。）は、店厨supportヒラマツ（以下、「当社」といいます。）がこのウェブサイト上で提供するメンテナンスサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </div>
